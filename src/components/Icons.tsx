...
export const GitlabIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M22.65 14.39L12 22.13 1.35 14.39a.84.84 0 0 1-.3-.94l1.22-3.78 2.44-7.51c.06-.18.2-.32.38-.37a.5.5 0 0 1 .53.15.54.54 0 0 1 .14.51L3.92 8.79h16.16l-1.84-6.35a.54.54 0 0 1 .14-.51.5.5 0 0 1 .53-.15c.18.05.32.19.38.37l2.44 7.51 1.22 3.78c.1.34 0 .73-.3.95z" />
  </svg>
);
